...
public class TodayAlertHistroyFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        dateData = "Date : "+F.parseDate(F.getCurDate(),"Year");
    ...
    public void fetchDefaultThreedaysAlert()
    {
        ...
        try
        {
            ...
            fromDateTime = F.getCurDate() + " " + "00:00:00";
            toDateTime = F.getCurDate() + " " + "23:59:59";
        ...
        protected void onPostExecute(String dataSm)
        {
            ...
            if(dataSm != null)
            {
                ...
                else if (success.equals("0"))
                {
                    ...
                    dateLinearLayout.setVisibility(View.GONE);
                    img_no_data.setImageResource(R.drawable.ic_alert_notf);
                    txt_error_no_data.setText(MyApplication.context.getResources().getString(R.string.tal_hist));
                }
