...
public class TodayDistFragment extends Fragment {
    ...
    public void getAlldata()
    {
        ...
        try
        {
            ...
            String from_to_date = F.getCurDate();
            String[] parameters =
                    {
                            Constants.USER_NAME + "#" + userName,
                            Constants.FROM_DATE + "#" + from_to_date,
                            Constants.TO_DATE + "#" + from_to_date
        ...
        protected void onPostExecute(String dataSm)
        {
            ...
            if(dataSm != null)
            {
                ...
                else if (success.equals("0"))
                {
                    ...
                    dateLinearLayout.setVisibility(View.GONE);
                    img_no_data.setImageResource(R.drawable.ic_gesture_black_48dp);
                    txt_error_no_data.setText(MyApplication.context.getResources().getString(R.string.t_dsum));
                }
