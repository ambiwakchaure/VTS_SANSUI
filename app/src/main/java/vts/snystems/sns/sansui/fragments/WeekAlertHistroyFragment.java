...
public class WeekAlertHistroyFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        dateData = "Date : "+F.parseDate(F.getSevenDayDate(),"Year")+" - "+F.parseDate(F.getCurDate(),"Year");
    ...
    public void fetchDefaultThreedaysAlert()
    {
        ...
        try
        {
            ...
            String  first_week_date = F.getSevenDayDate()+ " " + "00:00:00";
            String  currDate = F.getCurDate()+ " " + "23:59:59";
...
//                          Constants.FROM_DATE + "#" + "2018-06-27 00:00:00",
//                          Constants.TO_DATE + "#" + "2018-06-27 23:59:59"
                            Constants.USER_NAME + "#" + userName,
                            Constants.FROM_DATE + "#" + first_week_date,
        ...
        protected void onPostExecute(String dataSm)
        {
            ...
            if(dataSm != null)
            {
                ...
                else if (success.equals("0"))
                {
                    ...
                    dateLinearLayout.setVisibility(View.GONE);
                    img_no_data.setImageResource(R.drawable.ic_alert_notf);
                    txt_error_no_data.setText(MyApplication.context.getResources().getString(R.string.wal_hist));
                }
