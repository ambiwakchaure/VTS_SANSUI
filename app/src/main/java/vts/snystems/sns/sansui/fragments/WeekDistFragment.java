...
import vts.snystems.sns.sansui.adapter.DistanceSumAdapter;
...
import vts.snystems.sns.sansui.pojo.DistanceSummary;
...
public class WeekDistFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        dateRange = "Date : "+F.parseDate(F.getSevenDayDate(),"Year")+" - "+F.parseDate(F.getCurDate(),"Year");
    ...
    public void getAlldata()
    {
        ...
        try
        {
            ...
            String  first_week_date = F.getSevenDayDate();
        ...
        protected void onPostExecute(String dataSm)
        {
            ...
            if(dataSm != null)
            {
                ...
                else if (success.equals("0"))
                {
                    ...
                    dateLinearLayout.setVisibility(View.GONE);
                    img_no_data.setImageResource(R.drawable.ic_gesture_black_48dp);
                    txt_error_no_data.setText(MyApplication.context.getResources().getString(R.string.y_dsum));
                }
