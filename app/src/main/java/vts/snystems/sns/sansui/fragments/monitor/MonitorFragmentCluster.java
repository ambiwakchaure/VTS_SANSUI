package vts.snystems.sns.sansui.fragments.monitor;
...
public class MonitorFragmentCluster extends Fragment implements OnMapReadyCallback,ClusterManager.OnClusterItemInfoWindowClickListener<MarkerDialogInfo>
{
    ...
    private void setListener() {
            ...
            public void onClick(View view) {
                ...
                popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener()
                {
                    public boolean onMenuItemClick(MenuItem item)
                    {
                        ...
                        {
                            MyApplication.editor.putString(vts.snystems.sns.sansui.interfaces.Constants.MAP_TYPE, vts.snystems.sns.sansui.interfaces.Constants.MAP_TYPE_NORMAL).commit();
                        ...
                        {
                            MyApplication.editor.putString(vts.snystems.sns.sansui.interfaces.Constants.MAP_TYPE, vts.snystems.sns.sansui.interfaces.Constants.MAP_TYPE_SAT).commit();
                        ...
                        {
                            MyApplication.editor.putString(vts.snystems.sns.sansui.interfaces.Constants.MAP_TYPE, vts.snystems.sns.sansui.interfaces.Constants.MAP_TYPE_HY).commit();
        ...
        sosFloating.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                String SOS_FC = MyApplication.prefs.getString(vts.snystems.sns.sansui.interfaces.Constants.SOS_FC,"0");
                String SOS_SC = MyApplication.prefs.getString(vts.snystems.sns.sansui.interfaces.Constants.SOS_SC,"0");
                String SOS_TC = MyApplication.prefs.getString(vts.snystems.sns.sansui.interfaces.Constants.SOS_TC,"0");
    ...
    private void getDeviceDetails()
    {
        ...
        try
        {
            ...
            String[] parameters =
                    {
                            vts.snystems.sns.sansui.interfaces.Constants.USER_NAME + "#" + MyApplication.prefs.getString(vts.snystems.sns.sansui.interfaces.Constants.USER_NAME,"0")
                    };
            Rc.withParamsProgress(
                    ...
                    vts.snystems.sns.sansui.interfaces.Constants.webUrl + "" + vts.snystems.sns.sansui.interfaces.Constants.getVehicleInfo,
                    parameters,
                    getActivity(),
                    status);
        }
    ...
    Runnable mStatusChecker = new Runnable() {
        ...
        public void run()
        {
            ...
            mHandler.postDelayed(mStatusChecker, vts.snystems.sns.sansui.interfaces.Constants.monitorTimerDelay);
        }
    };
    ...
    class ParseResponse extends AsyncTask<String,String,String>
    {
        ...
        {
            String id = vts.snystems.sns.sansui.interfaces.Constants.NA;
            String imei = vts.snystems.sns.sansui.interfaces.Constants.NA;
            String vehicleNumber = vts.snystems.sns.sansui.interfaces.Constants.NA;
            String speed = vts.snystems.sns.sansui.interfaces.Constants.ZERO;
            String lastTrackedDateTime = vts.snystems.sns.sansui.interfaces.Constants.LTDATE_TIME;
            String vehicleType = vts.snystems.sns.sansui.interfaces.Constants.NA;
            String latitude = vts.snystems.sns.sansui.interfaces.Constants.NA;
            String longitude = vts.snystems.sns.sansui.interfaces.Constants.NA;
            String acc_status = vts.snystems.sns.sansui.interfaces.Constants.NA;
            String iconColor = vts.snystems.sns.sansui.interfaces.Constants.NA;
            String deviceStatus = vts.snystems.sns.sansui.interfaces.Constants.NA;
            String course = vts.snystems.sns.sansui.interfaces.Constants.ZERO;
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        //set Map type
        String mType = MyApplication.prefs.getString(vts.snystems.sns.sansui.interfaces.Constants.MAP_TYPE, vts.snystems.sns.sansui.interfaces.Constants.MAP_TYPE_NORMAL);

        if(mType.equals(vts.snystems.sns.sansui.interfaces.Constants.MAP_TYPE_NORMAL)|| mType.equals("साधारण") || mType.equals("सामान्य"))
        {
            mMap.setMapType(GoogleMap.MAP_TYPE_NORMAL);
            buttonMapType.setText(MyApplication.context.getResources().getString(R.string.normal));
        }
        else if(mType.equals(vts.snystems.sns.sansui.interfaces.Constants.MAP_TYPE_SAT) || mType.equals("साटलाईट"))
        {
            mMap.setMapType(GoogleMap.MAP_TYPE_SATELLITE);
            buttonMapType.setText(MyApplication.context.getResources().getString(R.string.satellite));
        }
        else if(mType.equals(vts.snystems.sns.sansui.interfaces.Constants.MAP_TYPE_HY) || mType.equals("हायब्रीड"))
        {
            mMap.setMapType(GoogleMap.MAP_TYPE_TERRAIN);
            buttonMapType.setText(MyApplication.context.getResources().getString(R.string.hybrid));
        }
