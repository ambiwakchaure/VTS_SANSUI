...
public class ArcProgress extends View {
    ...
    protected void initByAttributes(TypedArray attributes) {
        ...
        suffixText = TextUtils.isEmpty(attributes.getString(R.styleable.ArcProgress_arc_suffix_text))
                ? default_suffix_text : attributes.getString(R.styleable.ArcProgress_arc_suffix_text);
